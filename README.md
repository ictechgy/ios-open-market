...
- setUp을 사용하여 ParsingManager 인스턴스의 초기화를 매 테스트마다 해주었다.
...
위에서 봤듯이 이러한 비동기 작업 처리에 대해 indexPath를 비교하는 방법은 불확실하다. TableView에서만 쓰거나 아예 쓰지 말자. 
